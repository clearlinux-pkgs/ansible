...
Source0  : https://files.pythonhosted.org/packages/94/e2/b34a077f05f97982dfddf6ec17ab5e2e476412b3ff542e30d21d22cf2e2d/ansible-10.3.0.tar.gz
...
%prep
%setup -q -n ansible-10.3.0
cd %{_builddir}/ansible-10.3.0
pushd ..
cp -a ansible-10.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723559549
