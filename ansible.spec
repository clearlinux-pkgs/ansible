...
Source0  : https://files.pythonhosted.org/packages/50/40/35a204978b1ee8b78766169565f1bce7381d9c2802358e082554c5521502/ansible-10.6.0.tar.gz
...
%prep
%setup -q -n ansible-10.6.0
cd %{_builddir}/ansible-10.6.0
pushd ..
cp -a ansible-10.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730835121
