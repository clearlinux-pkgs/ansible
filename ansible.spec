...
Version  : 2.9.8
Release  : 99
URL      : https://github.com/ansible/ansible/archive/v2.9.8/ansible-2.9.8.tar.gz
Source0  : https://github.com/ansible/ansible/archive/v2.9.8/ansible-2.9.8.tar.gz
...
%prep
%setup -q -n ansible-2.9.8
cd %{_builddir}/ansible-2.9.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589311050
...
cp %{_builddir}/ansible-2.9.8/COPYING %{buildroot}/usr/share/package-licenses/ansible/338650eb7a42dd9bc1f1c6961420f2633b24932d
cp %{_builddir}/ansible-2.9.8/licenses/Apache-License.txt %{buildroot}/usr/share/package-licenses/ansible/c700a8b9312d24bdc57570f7d6a131cf63d89016
cp %{_builddir}/ansible-2.9.8/licenses/MIT-license.txt %{buildroot}/usr/share/package-licenses/ansible/df180fcf964224ba9180a646ca107bfe65595f23
cp %{_builddir}/ansible-2.9.8/licenses/PSF-license.txt %{buildroot}/usr/share/package-licenses/ansible/7b14725671bae6dc04be2b87de58131f0614dfad
cp %{_builddir}/ansible-2.9.8/packaging/debian/copyright %{buildroot}/usr/share/package-licenses/ansible/b7f3dc6d692392795202ab560c7583e986d8352b
