...
Source0  : https://files.pythonhosted.org/packages/f1/e3/0cca4bd57b2c5c39d403d369182080c5eecedeb58df74e39ea4a563ddff5/ansible-11.4.0.tar.gz
...
%prep
%setup -q -n ansible-11.4.0
cd %{_builddir}/ansible-11.4.0
pushd ..
cp -a ansible-11.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742933605
