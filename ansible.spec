...
Version  : 9.4.0
Release  : 179
URL      : https://files.pythonhosted.org/packages/03/ea/c1e9206d237237daf1fe48f3931641d87f510a3971a8015e5711b220237c/ansible-9.4.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/03/ea/c1e9206d237237daf1fe48f3931641d87f510a3971a8015e5711b220237c/ansible-9.4.0.tar.gz
...
%prep
%setup -q -n ansible-9.4.0
cd %{_builddir}/ansible-9.4.0
pushd ..
cp -a ansible-9.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711635923
