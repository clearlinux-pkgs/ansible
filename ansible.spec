...
Source0  : https://files.pythonhosted.org/packages/ad/c0/99e82b56a437f458e14f5bfd00ba1373b77a119643c201b62d3286ef6ef7/ansible-10.4.0.tar.gz
...
%prep
%setup -q -n ansible-10.4.0
cd %{_builddir}/ansible-10.4.0
pushd ..
cp -a ansible-10.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726001214
