...
Version  : 2.8.3
Release  : 84
URL      : https://github.com/ansible/ansible/archive/v2.8.3/ansible-2.8.3.tar.gz
Source0  : https://github.com/ansible/ansible/archive/v2.8.3/ansible-2.8.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565392543
