...
Version  : 2.7.7
Release  : 77
URL      : https://github.com/ansible/ansible/archive/v2.7.7.tar.gz
Source0  : https://github.com/ansible/ansible/archive/v2.7.7.tar.gz
Summary  : Empty RPM
...
export LANG=C
export SOURCE_DATE_EPOCH=1550191291
