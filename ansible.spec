...
Source0  : https://files.pythonhosted.org/packages/ce/67/600d142f895a5387679c676170431bd84a9a640b794d05b3689f847afad4/ansible-11.5.0.tar.gz
...
%prep
%setup -q -n ansible-11.5.0
cd %{_builddir}/ansible-11.5.0
pushd ..
cp -a ansible-11.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745420897
