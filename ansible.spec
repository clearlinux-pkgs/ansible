...
Source0  : https://files.pythonhosted.org/packages/a6/6f/b491cd89e0393810b67598098ccb6a204d6a9202c9733a541568f69f6dea/ansible-11.6.0.tar.gz
...
%prep
%setup -q -n ansible-11.6.0
cd %{_builddir}/ansible-11.6.0
pushd ..
cp -a ansible-11.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747787076
