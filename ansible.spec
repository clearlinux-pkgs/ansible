...
Source0  : https://files.pythonhosted.org/packages/f8/f4/9b52e828afa340c7d610ff35246e89bee3ca163dd2fe021db13142b2830c/ansible-10.0.0.tar.gz
...
%prep
%setup -q -n ansible-10.0.0
cd %{_builddir}/ansible-10.0.0
pushd ..
cp -a ansible-10.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717546054
