...
Source0  : https://files.pythonhosted.org/packages/05/9e/0ce74bc3429f9ca8f8a4c33ebdfadf68c347f265629fbaa4d24fb22db2bd/ansible-11.2.0.tar.gz
...
%prep
%setup -q -n ansible-11.2.0
cd %{_builddir}/ansible-11.2.0
pushd ..
cp -a ansible-11.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738100828
...
cp %{_builddir}/ansible-%{version}/ansible_collections/check_point/mgmt/LICENSE %{buildroot}/usr/share/package-licenses/ansible/ff426822972c8972e3e4e782baac6f5304fd458c || :
...
/usr/share/package-licenses/ansible/ff426822972c8972e3e4e782baac6f5304fd458c
