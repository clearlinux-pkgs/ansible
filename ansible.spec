...
Source0  : https://files.pythonhosted.org/packages/c5/8d/701590703e9bb6359a335ee88a9223442fe6abfae056928876d8318e8c07/ansible-9.2.0.tar.gz
...
%prep
%setup -q -n ansible-9.2.0
cd %{_builddir}/ansible-9.2.0
pushd ..
cp -a ansible-9.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706714673
