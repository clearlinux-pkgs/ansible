...
Version  : 2.2.2.0
Release  : 33
URL      : http://releases.ansible.com/ansible/ansible-2.2.2.0.tar.gz
Source0  : http://releases.ansible.com/ansible/ansible-2.2.2.0.tar.gz
...
%prep
%setup -q -n ansible-2.2.2.0
%patch1 -p1

%build
export LANG=C
export SOURCE_DATE_EPOCH=1490794841
