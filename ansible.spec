...
Version  : 2.7.8
Release  : 78
URL      : https://github.com/ansible/ansible/archive/v2.7.8.tar.gz
Source0  : https://github.com/ansible/ansible/archive/v2.7.8.tar.gz
Summary  : Empty RPM
...
export LANG=C
export SOURCE_DATE_EPOCH=1550788216
