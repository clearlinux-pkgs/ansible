...
Source0  : https://files.pythonhosted.org/packages/89/c6/c61a1aa2cbddf8a426eca157d4ab19d346247d86bc45cc6ac40efc41a2c2/ansible-10.2.0.tar.gz
...
%prep
%setup -q -n ansible-10.2.0
cd %{_builddir}/ansible-10.2.0
pushd ..
cp -a ansible-10.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721228466
