...
Version  : 2.5.0
Release  : 51
URL      : https://github.com/ansible/ansible/archive/v2.5.0.tar.gz
Source0  : https://github.com/ansible/ansible/archive/v2.5.0.tar.gz
Summary  : Empty RPM
...
export LANG=C
export SOURCE_DATE_EPOCH=1521824367
